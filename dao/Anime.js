...
export default class Anime {
    constructor(id, prequelId, name, format, episodes, episodeDurationMins, status, startDate, finishDate,
        ...
        if(myStartDate && startDate && myStartDate < startDate)
...
export async function addAnime(anime, genreIds) {
    ...
    if(genreIds) {
        for(const genreId of genreIds) {
            ...
            } catch(e) {console.error('Could not insert genre: ' + genreId + 'for anime: ' + anime.id + '. ' + e.message)}
        }
    }
}
...
export async function searchAnime(id) {
    ...
    } catch(e) {console.error('Error while searching anime ' + id + 'from database! ' + e.message)}
}
...
export async function getAllGenreForAnime(animeId) {
    ...
    try {
        ...
        return allGenre
    } catch(e) {console.error('Error while searching all genre for anime ' + animeId + 'from database! ' + e.message)}
}
...
export async function searchAnimeBySeries(animeSeriesId) {
    ...
    } catch(e) {console.error('Error while searching anime by series for id: ' + animeSeriesId + ' from database! ' + e.message)}
}
...
export async function updateAnime(anime) {
    ...
    } catch(e) {console.error('Error while updating anime ' + anime.id + ' in database! ' + e.message)}
}
...
export async function deleteAnime(id) {
    ...
    } catch(e) {console.error('Error while deleting anime ' + id + ' from database! ' + e.message)}
}